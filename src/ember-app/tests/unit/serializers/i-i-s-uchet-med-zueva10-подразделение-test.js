...
moduleForModel('i-i-s-uchet-med-zueva10-подразделение', 'Unit | Serializer | i-i-s-uchet-med-zueva10-подразделение', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-uchet-med-zueva10-подразделение',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
